...
@Repository
public interface TinRegistrationProcessRepository extends MongoRepository<TinRegistrationProcess, String> {
    ...
    public List<TinRegistrationProcess> findByTinIdIn(List<String> tinsId);
